...
dp[i][j] = dp[i-1][j] or dp[i-1][j-weight[i]]
...
class Solution:
    def wordBreak(self, s: str, wordDict: List[str]) -> bool:
        dp = [False]*(len(s) + 1)
        dp[0] = True
        for i in range(1, len(s) + 1):  # 先背包  1~n
...
[Links](https://www.programmercarl.com/0139.%E5%8D%95%E8%AF%8D%E6%8B%86%E5%88%86.html)

#### 2. 最长递增子序列：整数数组中找出最长严格递增子序列的长度
...
#### 3.  最长公共子序列: 两个字符串的最长公共子序列的长度

<img src="/Users/admin/Library/Application Support/typora-user-images/image-20241211下午104930090.png" alt="image-20241211下午104930090" style="zoom:50%;" />
...
4. 顺序
   ...
   <img src="/Users/admin/Library/Application Support/typora-user-images/image-20241211下午105348197.png" alt="image-20241211下午105348197" style="zoom:50%;" />
...
[Links](https://github.com/youngyangyang04/leetcode-master/blob/34990fb96f42f370e7d605cbad1e731018c3922d/problems/0005.%E6%9C%80%E9%95%BF%E5%9B%9E%E6%96%87%E5%AD%90%E4%B8%B2.md)
    ...
    def longestPalindrome(self, s: str) -> str:
        ...
        def expand(left,right,s):
            ...
            while left>=0 and right<len(s) and s[left]==s[right]:
                left-=1
                right+=1
            return s[left+1:right] # while循环终止时，多往外扩了 所以回来   左开右闭
...
#### 5. 最短编辑距离: 两个单词 word1 和 word2，将 word1 转换成 word2 所使用的最少操作数 
...
3. 顺序
   ...
   <img src="/Users/admin/Library/Application Support/typora-user-images/image-20241211下午115724714.png" alt="image-20241211下午115724714" style="zoom:50%;" />
