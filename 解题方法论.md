...
| 排列 | used       | len(path)==len(nums) | range(==len(nums)==)  每次全遍历                        | backtrack(nums,used)       |
...
1. 背包容量从==0==开始
2. 明确3个问题   01背包or完全背包、组合or排列、具体子问题

![image-20241230下午90939607](./assets/image-20241230下午90939607.png)
